...
public final class CameraManager {
	...
	private static final int MAX_FRAME_WIDTH = 340; // = 5/8 * 1920   //1200
	private static final int MAX_FRAME_HEIGHT = 340; // = 5/8 * 1080   //675
	private static final int DEFAULT_TOP_PADDINF = 120;   //200
