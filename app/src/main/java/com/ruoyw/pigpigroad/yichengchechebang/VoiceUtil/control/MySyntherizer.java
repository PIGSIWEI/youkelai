package com.ruoyw.pigpigroad.yichengchechebang.VoiceUtil.control;
...
import com.ruoyw.pigpigroad.yichengchechebang.VoiceUtil.MainHandlerConstant;
...
public class MySyntherizer implements MainHandlerConstant {
    ...
    protected void sendToUiThread(String message) {
        ...
        Log.i(PP_TIP, String.valueOf(PRINT)+message);
    }
