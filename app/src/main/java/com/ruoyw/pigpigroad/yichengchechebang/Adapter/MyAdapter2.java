...
import com.ruoyw.pigpigroad.yichengchechebang.Widget.DragAdapterInterface;
...
public class MyAdapter2 extends BaseAdapter implements DragAdapterInterface {
    ...
    public MyAdapter2(MenuManageActivity2 context, MyApplication appContext, List<MenuEntity> datas) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        MyAdapter2.Holder holder;
        if (convertView == null) {
            holder = new MyAdapter2.Holder();
            ...
            holder = (MyAdapter2.Holder) convertView.getTag();
        }
