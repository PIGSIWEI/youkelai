 ...
 */
public class MySyntherizer2 implements MainHandlerConstant {
...
//    public MySyntherizer2(Context context, InitConfig initConfig, Handler mainHandler) {
//        this(context, mainHandler);
//        init(initConfig);
//    }


    protected MySyntherizer2(Context context, Handler mainHandler, InitConfig initConfig) {
        if (isInitied) {
