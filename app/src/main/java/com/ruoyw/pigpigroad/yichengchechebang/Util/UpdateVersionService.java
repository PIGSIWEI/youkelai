...
public class UpdateVersionService extends Service {
    ...
    public void onCreate() {
        ...
        updateFile = new File(SDCardUtils.getRootDirectory() + "/updateVersion/YKL.apk");

        nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        notification = new Notification();
        notification.icon = R.drawable.icon_ykl;
...
//                startActivity(installIntent);
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    ...
                    Uri uri = FileProvider.getUriForFile(getApplication(), "com.ruoyw.pigpigroad.yichengchechebang.Util.UpdateVersionService", updateFile);
